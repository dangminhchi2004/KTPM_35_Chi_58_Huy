...
namespace _35_Chi_58_Huy_TestWebCellPhoneS
{
    [TestClass]
    public class UnitTest_35_Chi_58_Huy
    {
        ...
        public void LoginToCellPhones_35_Chi_58_Huy(string sdt, string matkhau)//Hàm đăng nhập vào website
        {
  ...
  *  Login Test  *
  ****************/
        //[TestMethod]//TC01: Đăng nhập thành công
        public void TC01_LoginSucess_35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
            Thread.Sleep(1000);
        ...
        //[TestMethod]//TC02: Đăng nhập thất bại do sai mật khẩu
        public void TC02_LoginFail1_35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
            Thread.Sleep(1000);
            ...
            Thread.Sleep(1000);
            driver_35_Chi_58_Huy.FindElement(By.CssSelector("#login-form > div.cps-login-form > form > div > div:nth-child(1) > div > input")).SendKeys("0379038920");
            driver_35_Chi_58_Huy.FindElement(By.CssSelector("#login-form > div.cps-login-form > form > div > div.mt-4 > div > input ")).SendKeys("MatKhau");//Nhập sai mật khẩu
            ...
            try
            {
                ...
                Assert.IsTrue(errorMessage.Displayed, "Passed");
            }
            catch (NoSuchElementException)
            {
                Assert.Fail("Error message not found, test failed.");
            }
        }

        //[TestMethod]//TC03: Đăng nhập thất bại do sai số điện thoại
        public void TC03_LoginFai2__35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
            Thread.Sleep(1000);
            ...
            driver_35_Chi_58_Huy.FindElement(By.CssSelector("#modalLogin > div.modal-content.modal-login > div.group-login-btn > div.login-btn")).Click();
            Thread.Sleep(1000);
            driver_35_Chi_58_Huy.FindElement(By.CssSelector("#login-form > div.cps-login-form > form > div > div:nth-child(1) > div > input")).SendKeys("0999999999");// Nhập sai số điện thoại
            driver_35_Chi_58_Huy.FindElement(By.CssSelector("#login-form > div.cps-login-form > form > div > div.mt-4 > div > input ")).SendKeys("19t6n2k4Chi");
         ...
         *  Search Test
         ****************/
        //[TestMethod]/TC04: Tìm kiếm sản phẩm thành công
        public void TC04_Seach1_35_Chi_58_Huy()
        {
            ...
            try
            {
                // Check if the message contains "Tìm thấy 0 sản phẩm cho từ khoá".
        ...
        //[TestMethod]//TC05: Tìm kiếm sản phẩm không tồn tại
        public void TC05_Seach2_35_Chi_58_Huy()
        {
        ...
        ****************/
        ...
        //[TestMethod]//TC06: Thêm sản phẩm vào giỏ hàng thành công
        public void TC06_AddProductToCart1_35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Manage().Window.Maximize();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
        ...
        //[TestMethod]//TC07: Thêm sản phẩm không thành công
        public void TC07_AddProductToCart2_35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Manage().Window.Maximize();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
        ...
        [TestMethod]//TC08: Xóa sản phẩm khỏi giỏ hàng thành công
        public void TC08_RemoveProductFromCart1_35_Chi_58_Huy()
        {
            driver_35_Chi_58_Huy = new ChromeDriver();
            driver_35_Chi_58_Huy.Manage().Window.Maximize();
            driver_35_Chi_58_Huy.Navigate().GoToUrl("https://cellphones.com.vn/");
